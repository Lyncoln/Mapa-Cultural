...
Com o tibble completo de informações, utilizamos a função readOGR do pacote rgdal para ler a malha dos municípios do estado do Rio de Janeiro, para em seguida utilizar o pacote leaflet, que gera um mapa global com o RJ marcado. Configuramos o mapa para que todos os endereços do tibble sejam marcados. Para melhor visualização, criamos marcadores de circulos e também um mapa de calor. Há possibilidade de observar dois tipos diferentes de mapas, o Esri.WorldImagery ou o CartoDB.
